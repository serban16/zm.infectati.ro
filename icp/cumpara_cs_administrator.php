...
<div class="pageContent">
	...
	<?php require 'meniu.php'; ?>
		...
		if($_SESSION['id'])
		{
			...
			$commanda="SELECT * FROM preturi WHERE nume_produs = 'cs_administrator'";
			...
			if($_POST['submit']=='Da')
			{
				...
				if ($balanta >= $pret)
				{
					...
					$Body = "";
					$Body .= "Ai cumparat pe Cs.infectati.ro Administrator si iti expira pe data de ";
					$Body .= $expiry;					
					$Body .= "\n";
					...
					mysql_query("INSERT INTO log(comanda,admin,data) VALUES ('$auth a cumpara Administrator pe cs.infectati.ro si a platit $pret Euro','$admin',NOW())");
		...
		<center>
			<h3>Esti sigur ca vrei sa cumperi Administrator pe server-ul Cs.infectati.ro ?<br><br></h3>
