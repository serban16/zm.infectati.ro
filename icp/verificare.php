...
<body>
		...
		while($row2 = mysql_fetch_array($cauta_query32))
		{
			...
			$id_meci5 = $row2["id_meci4"];
			$id_meci6 = $row2["id_meci5"];
...
<td><?php if ($echipa1 == $results1["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results1["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?> </td>
	</tr>
<?php
}
?>
...
<td><?php if ($echipa2 == $results2["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results2["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa3; ?></td>
<td><?php echo $cota3; ?></td>
<td><?php if ($echipa3 == $results3["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results3["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa4; ?></td>
<td><?php echo $cota4; ?></td>
<td><?php if ($echipa4 == $results4["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results4["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa5; ?></td>
<td><?php echo $cota5; ?></td>
<td><?php if ($echipa5 == $results5["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results5["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa6; ?></td>
<td><?php echo $cota6; ?></td>
<td><?php if ($echipa6 == $results6["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results6["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa7; ?></td>
<td><?php echo $cota7; ?></td>
<td><?php if ($echipa7 == $results7["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results7["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa8; ?></td>
<td><?php echo $cota8; ?></td>
<td><?php if ($echipa8 == $results8["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results8["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa9; ?></td>
<td><?php echo $cota9; ?></td>
<td><?php if ($echipa9 == $results9["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results9["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa10; ?></td>
<td><?php echo $cota10; ?></td>
<td><?php if ($echipa10 == $results10["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results10["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa11; ?></td>
<td><?php echo $cota11; ?></td>
<td><?php if ($echipa11 == $results11["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results11["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa12; ?></td>
<td><?php echo $cota12; ?></td>
<td><?php if ($echipa12 == $results12["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results12["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa13; ?></td>
<td><?php echo $cota13; ?></td>
<td><?php if ($echipa13 == $results13["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results13["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
?>
...
<td><?php echo $echipa14; ?></td>
<td><?php echo $cota14; ?></td>
<td><?php if ($echipa14 == $results14["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results14["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
<td></td>
	</tr>
<?php
}
...
<td><?php echo $echipa15; ?></td>
<td><?php echo $cota15; ?></td>
<td><?php if ($echipa15 == $results15["echipa_castigatoare"]) { echo 'Castigat'; $stare = "castigat"; } else if ($results15["echipa_castigatoare"] == "") { echo 'Nejucat'; } else { echo 'Pierdut'; $stare2 = "pierdut"; } ?></td>
	</tr>
<?php
}
...
?>
  ...
  <h3>Stare bilet: <?php if ($stare == "castigat" && $stare2 == "pierdut") $stare = "pierdut"; else $stare = "castigat"; if ($stare == "pierdut") echo "Bilet Necastigator"; else if ($stare == "castigator") { echo "Bilet Castigator"; ?> <form name="paruiri3" action="" method="post"> <input type="hidden" name="nrbilet2" value="<?php echo $nr_bilet; ?>" /> <input type="submit" name="extrage" value="Extrage Banii" class="buton_albastru" />  </form>  <?php } else { echo 'Nu s-au jucat toate meciurile';}?></h3>
