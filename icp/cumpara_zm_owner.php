...
<?php require 'meniu.php'; ?>
		...
		{ 
			...
			$commanda="SELECT * FROM preturi WHERE nume_produs = 'zm_owner'";
			...
			if($_POST['submit']=='Da')
			{
				...
				if ($balanta >= $pret)
				{
					...
					$Body = "";
					$Body .= "Ai cumparat pe Zm.infectati.ro Owner si iti expira pe data de ";
					$Body .= $expiry;					
					$Body .= "\n";
					...
					mysql_query("INSERT INTO log(comanda,admin,data) VALUES ('$auth a cumpara Owner pe zm.infectati.ro si a platit $pret Euro','$admin',NOW())");
		...
		<center>
			<h3>Esti sigur ca vrei sa cumperi Owner pe server-ul Zm.infectati.ro ?<br><br></h3>
