...
<div class="pageContent">
    <div id="main">
      <div class="container">
		...
		{ 
			...
			if($_POST['submit']=='Da')
			{
				...
				if ($balanta >= $pret)
				{
					...
					$Body = "";
					$Body .= "Ai cumparat pe Cs.infectati.ro Slot si iti expira pe data de ";
					$Body .= $expiry;					
					$Body .= "\n";
					...
					mysql_query("INSERT INTO log(comanda,admin,data) VALUES ('$auth a cumpara Slot pe cs.infectati.ro si a platit $pret Euro','$admin',NOW())");
		...
		<center>
			<h3>Esti sigur ca vrei sa cumperi Slot pe server-ul Cs.infectati.ro ?<br><br></h3>
