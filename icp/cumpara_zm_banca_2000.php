...
<?php require 'meniu.php'; ?>
		...
		{ 
			...
			$commanda="SELECT * FROM preturi WHERE nume_produs = 'zm_banca_2000'";
			...
			if($_POST['submit']=='Da')
			{
				...
				if ($balanta >= $pret)
				{
					...
					$Body = "";
					$Body .= "Ai cumparat pe Zm.infectati.ro Marire banca la 2000 Euro si iti expira pe data de ";
					$Body .= $expiry;					
					$Body .= "\n";
					...
					mysql_query("INSERT INTO log(comanda,admin,data) VALUES ('$auth a cumpara prelungire banca 2000 Euro pe zm.infectati.ro si a platit $pret Euro','$admin',NOW())");
		...
		<center>
			<h3>Esti sigur ca vrei sa cumperi Marire banca la 2000 Euro pe server-ul Zm.infectati.ro ?<br><br></h3>
