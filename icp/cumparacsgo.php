...
<div class="pageContent">
    <div id="main">
      <div class="container">
        <h1>Cumpara Grad pe CSGO.infectati.ro</h1>
    ...
    <tr><td>Slot</td><td><?php echo $pret; ?> Euro</td><td><a href="cumpara_csgo_slot.php">Cumpara</a></td></tr>
	<tr><td>Mini-Admin</td><td><?php echo $pret2; ?> Euro</td><td><a href="cumpara_csgo_mini_admin.php">Cumpara</a></td></tr>
    <tr><td>Co-Administrator</td><td><?php echo $pret3; ?> Euro</td><td><a href="cumpara_csgo_co_administrator.php">Cumpara</a></td></tr>
    <tr><td>Administrator</td><td><?php echo $pret4; ?> Euro</td><td><a href="cumpara_csgo_administrator.php">Cumpara</a></td></tr>
    <tr><td>Owner</td><td><?php echo $pret5; ?> Euro</td><td><a href="cumpara_csgo_owner.php">Cumpara</a></td></tr>
    </table>
	<br>
