    ...
    <div id="main">
 	...
 	<?php require 'meniu.php'; ?>
		...
		{ 
			...
			$commanda="SELECT * FROM preturi WHERE nume_produs = 'cs_owner'";
			...
			if($_POST['submit']=='Da')
			{
				...
				if ($balanta >= $pret)
				{
					...
					$today = date("Y-m-d", time());
						...
						if ($cs_access == "z")
						{
							$cs_access = "abcdefghijklmnopqrstu";
						}
					...
					$Body = "";
					$Body .= "Ai cumparat pe Cs.infectati.ro Owner si iti expira pe data de ";
					$Body .= $expiry;					
					$Body .= "\n";
					...
					mysql_query("INSERT INTO log(comanda,admin,data) VALUES ('$auth a cumpara Owner pe cs.infectati.ro si a platit $pret Euro','$admin',NOW())");
		...
		<center>
			<h3>Esti sigur ca vrei sa cumperi Owner pe server-ul Cs.infectati.ro ?<br><br></h3>
