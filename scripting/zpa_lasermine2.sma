...
new const
	...
	STR_CANTBUY[]				= "Nu poti sa cumperi lasermine ori ai deja maximum de lasere!",
	...
	STR_SECONDS[]				= "secunde.",
	STR_BOUGHT[]				= "Ai cumparat cu succes laser-ul.",
	STR_STATE[]					= "Lasere:",
...
new g_msgDeathMsg,g_msgScoreInfo,g_msgDamage,g_msgStatusText,g_msgMoney, g_NOROUND, g_NEMROUND, g_SURVROUND, g_ASSROUND, g_SNIPERROUND, g_ARMAROUND, g_PLAGUEROUND, g_ASSASSIN_VS_SNIPER, g_autobindlaser ;
...
public plugin_init() {
	...
	g_LCOST					= register_cvar("zpa_lm_cost","0");
	g_LFMONEY				= register_cvar("zpa_lm_fragmoney","0");
	g_LHEALTH				= register_cvar("zpa_lm_viata","1000");
	g_LTMAX					= register_cvar("zpa_lm_echipamax","45");
	...
	g_LBUYMODE				= register_cvar("zpa_lm_buymode","0");
