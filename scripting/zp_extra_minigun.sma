...
// Weapon information
new const g_item_name[] = { "MiniGun + x2 Damage" }
const g_item_cost = 250
// other
...
public plugin_init() {
	...
	DMGMG =		register_cvar("amx_minigun_damage","2.00")
	oneround = 	register_cvar("amx_oneround","1")
	g_itemid_minigun = zv_register_extra_item(g_item_name, "o runda", g_item_cost, ZV_TEAM_HUMAN)
