...
public plugin_init()
{
	...
	// Variables
	g_iItemID = zv_register_extra_item("Drujba", "o runda", chainsaw_ap_cost, ZV_TEAM_HUMAN)
	...
	if (itemid == g_iItemID)
	{
		...
		if(get_pcvar_num(cvar_enable))
		{
			...
			if (g_iHasChainsaw[id])
			{
				...
				client_printcolor(id, "/g[ZP]/y Tu ai deja o /gDrujba")
			}
			else 
			{
				// Boolean
				...
				// Client Print
				client_printcolor(id, "/g[ZP]/y Ai cumparat o /gDrujba")
