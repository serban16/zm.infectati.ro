...
public reload_bank() {
	...
	if (AdminCount == 1)
		server_print("[%L] %L", LANG_PLAYER, "BANK_PREFIX", LANG_SERVER, "BANK_LOADED_ADMIN");
	else
		server_print("[%L] %L", LANG_PLAYER, "BANK_PREFIX", LANG_SERVER, "BANK_LOADED_ADMINS", AdminCount);
}
