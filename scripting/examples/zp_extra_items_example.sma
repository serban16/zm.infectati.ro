...
public plugin_init()
{
	...
	g_itemid2 = zp_register_extra_item("My Extra Item 2", 3, ZP_TEAM_HUMAN | ZP_TEAM_SNIPER | ZP_TEAM_SURVIVOR) // Humans, Snipers and Survivors only 
	g_itemid3 = zp_register_extra_item("My Extra Item 3", 4, ZP_TEAM_ASSASSIN | ZP_TEAM_NEMESIS) // Assassins and Nemesis only
}
