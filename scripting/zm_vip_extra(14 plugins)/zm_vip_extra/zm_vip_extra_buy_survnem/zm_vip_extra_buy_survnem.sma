...
public plugin_init() {
	...
	// Extra items
	nemesis = zv_register_extra_item("Cumpara Nemesis", "Pentru o runda", get_pcvar_num(cvar_n_price), 0)
	survivor = zv_register_extra_item("Cumpara Supravietuitor","Pentru o runda", get_pcvar_num(cvar_s_price), 0)
}
