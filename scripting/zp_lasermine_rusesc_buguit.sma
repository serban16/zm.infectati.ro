...
#define AUTHOR "SandStriker/Shidla/QuZ/Jamez"
...
new const
	...
	gSnarkClassName[]	=	"wpn_snark",	// ??? ????????????? ? ???????? "Snark"
	barnacle_class[]	=	"barnacle",		// ??? ????????????? ? ???????? "Barnacle"
	weapon_box[]		=	"weaponbox";

new g_EntMine, beam, boom
new g_LENABLE, g_LFMONEY, g_LAMMO, g_LDMG, g_LBEO, g_LTMAX, g_LCOST, g_LHEALTH, g_LMODE, g_LRADIUS, g_NOROUND, g_NEMROUND, g_SURVROUND, g_ASSROUND, g_SNIPERROUND, g_ARMAROUND, g_PLAGUEROUND
