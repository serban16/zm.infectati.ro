...
new g_msgDeathMsg,g_msgScoreInfo,g_msgDamage,g_msgStatusText,g_msgMoney, g_NOROUND, g_NEMROUND, g_SURVROUND, g_ASSROUND, g_SNIPERROUND, g_ARMAROUND, g_PLAGUEROUND, g_autobindlaser ;
...
public plugin_init() {
	...
	g_LDMG					= register_cvar("zpa_lm_dmg","300");
