...
public plugin_init()
{
	...
	// Cvars
	FrostTime = register_cvar("zp_ng_frost_time", "15.0") // Time to Remove the Frost Effect
	...
	// ITEM NAME & COST
	gc_itemID = zv_register_extra_item("Arma cu Gheata", "o runda", 30, ZV_TEAM_HUMAN)
...
//**************************************************************************************************************************/
public zv_user_infected_post(infected, infector)
{
